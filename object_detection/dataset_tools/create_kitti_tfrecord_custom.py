...
tf.app.flags.DEFINE_string('data_dir', '/media/aev21/d15d0282-a376-47ba-bdf5-855a03695f32/data/KITTI', 'Location of root directory for the '
                           ...
                           '(images).')
tf.app.flags.DEFINE_string('image_list', '/home/aev21/data/KITTI/txt_files/avg/6500/all_sorted_avg_with_avg_var.txt', 'File where images are stored.')
...
tf.app.flags.DEFINE_integer('set_size', '65', 'Number of images to'
                            'be used as budget.')
tf.app.flags.DEFINE_string('al_set_id', 'fifth_65_avg', 'tfrecord name.')
...
def convert_kitti_to_tfrecords(data_dir, al_data_dir, output_path, classes_to_use,
  ...
  images_list = images_list_all[:set_size]
