...
def create_input_queue(batch_size_per_clone, create_tensor_dict_fn,
  ...
  images_resized = tf.image.resize_image_with_crop_or_pad(images, 376, 1242)
  del images

  float_images = tf.to_float(images_resized)
...
def train(create_tensor_dict_fn,
  ...
  with tf.Graph().as_default():
    ...
    slim.learning.train(
        ...
        save_summaries_secs=10, #FOR AUDI 60, #FOR KITTI 10
        save_interval_secs=120, #FOR AUDI 780, #FOR KITTI 120
