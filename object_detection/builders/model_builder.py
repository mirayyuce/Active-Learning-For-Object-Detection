...
def build(model_config, is_training, add_summaries=True, mc_dropout = False):
...
def _build_faster_rcnn_model(frcnn_config, is_training, add_summaries, mc_dropout):
